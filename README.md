...
make sure to see the [`LICENSE`](LICENSE) file before using any of the content in this repository.

## my paper

a detailed summary of all my findings can be found in [`paper/paper.pdf`](paper/paper.pdf). this includes a rough introduction to navier-stokes for those who would like a ground-up introduction to my work.
...
i have read various textbooks and research papers , all of which can be found in [`REFERENCES.md`](REFERENCES.md). you can also see [`paper/references.bib`](paper/references.bib) for the bibtex citations for any papers whose results i mentioned or used in any way in my work. papers i've especially read can also be found as pdfs in [`references/`](references/).
